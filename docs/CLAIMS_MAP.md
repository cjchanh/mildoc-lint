...
| No compliance certification | README "What it is not" section. INTENT.md. Test: `tests/test_no_overclaim.py::test_no_banned_phrases_in_repo_markdown` blocks "DoD approved", "CMMC compliant", "RMF ready", etc. |
